...
class CalendarsControllerTest < ActionController::TestCase
  ...
  test "should create calendar" do
    assert_difference('Calendar.count') do
      post :create, calendar: { calendario: @calendar.calendario, fecha_corte: @calendar.fecha_corte, status_id: @calendar.status_id }
    end
  ...
  test "should update calendar" do
    patch :update, id: @calendar, calendar: { calendario: @calendar.calendario, fecha_corte: @calendar.fecha_corte, status_id: @calendar.status_id }
    assert_redirected_to calendar_path(assigns(:calendar))
  end

...
class IpAddressesControllerTest < ActionController::TestCase
  ...
  test "should create ip_address" do
    assert_difference('IpAddress.count') do
      post :create, ip_address: { ip_address: @ip_address.ip_address, ip_status_id: @ip_address.ip_status_id, sectorial_id: @ip_address.sectorial_id }
    end
  ...
  test "should update ip_address" do
    patch :update, id: @ip_address, ip_address: { ip_address: @ip_address.ip_address, ip_status_id: @ip_address.ip_status_id, sectorial_id: @ip_address.sectorial_id }
    assert_redirected_to ip_address_path(assigns(:ip_address))
  end
